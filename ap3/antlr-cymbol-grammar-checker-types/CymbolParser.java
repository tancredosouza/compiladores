...
public class CymbolParser extends Parser {
    ...
    public static final int
        TYPEINT=1, TYPEVOID=2, TYPEFLOAT=3, TYPESTRING=4, TYPEBOOLEAN=5, IF=6, 
        ...
        MINUS=26, AND=27, OR=28, BOOLEAN=29, INT=30, FLOAT=31, STRING=32, ID=33, 
    ...
    private static final String[] _LITERAL_NAMES = {
        null, "'int'", "'void'", "'float'", "'string'", "'boolean'", "'if'", "'else'", 
        "'return'", "'('", "')'", "','", "';'", "'{'", "'}'", "'='", "'=='", "'!='", 
        "'!'", "'>'", "'<'", "'>='", "'<='", "'*'", "'/'", "'+'", "'-'", "'&&'", 
        "'||'"
    };
    private static final String[] _SYMBOLIC_NAMES = {
        null, "TYPEINT", "TYPEVOID", "TYPEFLOAT", "TYPESTRING", "TYPEBOOLEAN", 
        "IF", "ELSE", "RETURN", "LP", "RP", "COMMA", "SEMICOLON", "LB", "RB", 
        "AS", "EQ", "NE", "NOT", "GT", "LT", "GE", "LE", "MUL", "DIV", "PLUS", 
        "MINUS", "AND", "OR", "BOOLEAN", "INT", "FLOAT", "STRING", "ID", "BLOCKCOMMENT", 
        "LINECOMMENT", "WS"
    };
    ...
    public final FileContext file() throws RecognitionException {
        ...
        try {
            ...
            do {
                ...
                _errHandler.sync(this);
                _la = _input.LA(1);
            } while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << TYPEINT) | (1L << TYPEVOID) | (1L << TYPEFLOAT) | (1L << TYPESTRING) | (1L << TYPEBOOLEAN))) != 0) );
            setState(41);
            _errHandler.sync(this);
    ...
    public final FuncDeclContext funcDecl() throws RecognitionException {
        ...
        try {
            ...
            setState(62);
            _la = _input.LA(1);
            if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << TYPEINT) | (1L << TYPEVOID) | (1L << TYPEFLOAT) | (1L << TYPESTRING) | (1L << TYPEBOOLEAN))) != 0)) {
                {
                setState(61);
                paramTypeList();
                }
    ...
    public final BlockContext block() throws RecognitionException {
        ...
        try {
            ...
            _errHandler.sync(this);
            _la = _input.LA(1);
            while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << TYPEINT) | (1L << TYPEVOID) | (1L << TYPEFLOAT) | (1L << TYPESTRING) | (1L << TYPEBOOLEAN) | (1L << IF) | (1L << RETURN) | (1L << LP) | (1L << NOT) | (1L << PLUS) | (1L << MINUS) | (1L << BOOLEAN) | (1L << INT) | (1L << FLOAT) | (1L << STRING) | (1L << ID))) != 0)) {
                {
                {
                setState(79);
                stat();
    ...
    public final ReturnStatContext returnStat() throws RecognitionException {
        ...
        try {
            ...
            setState(94);
            _la = _input.LA(1);
            if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << LP) | (1L << NOT) | (1L << PLUS) | (1L << MINUS) | (1L << BOOLEAN) | (1L << INT) | (1L << FLOAT) | (1L << STRING) | (1L << ID))) != 0)) {
                {
                setState(93);
                expr(0);
                }
    ...
    public static class AndOrExprContext extends ExprContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if ( visitor instanceof CymbolVisitor ) return ((CymbolVisitor<? extends T>)visitor).visitAndOrExpr(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class BooleanExprContext extends ExprContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if ( visitor instanceof CymbolVisitor ) return ((CymbolVisitor<? extends T>)visitor).visitBooleanExpr(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static final String _serializedATN =
        ...
        "\2\3+*\3\2\2\2+,\3\2\2\2,\3\3\2\2\2-.\5\6\4\2.\61\7#\2\2/\60\7\21\2\2"+
        "\60\62\5\"\22\2\61/\3\2\2\2\61\62\3\2\2\2\62\63\3\2\2\2\63\64\7\16\2\2"+
        "\64\5\3\2\2\2\65;\7\3\2\2\66;\7\4\2\2\67;\7\7\2\28;\7\6\2\29;\7\5\2\2"+
        ":\65\3\2\2\2:\66\3\2\2\2:\67\3\2\2\2:8\3\2\2\2:9\3\2\2\2;\7\3\2\2\2<="+
        "\5\6\4\2=>\7#\2\2>@\7\13\2\2?A\5\n\6\2@?\3\2\2\2@A\3\2\2\2AB\3\2\2\2B"+
        "C\7\f\2\2CD\5\16\b\2D\t\3\2\2\2EJ\5\f\7\2FG\7\r\2\2GI\5\f\7\2HF\3\2\2"+
        ...
        "\2\2\2UW\3\2\2\2VT\3\2\2\2WX\7\20\2\2X\17\3\2\2\2YZ\7#\2\2Z[\7\21\2\2"+
