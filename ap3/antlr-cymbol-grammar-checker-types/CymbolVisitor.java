...
public interface CymbolVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code FormTypeFloat}
	 * labeled alternative in {@link CymbolParser#type}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFormTypeFloat(CymbolParser.FormTypeFloatContext ctx);
	/**
	 * Visit a parse tree produced by the {@code FormTypeBoolean}
	 * labeled alternative in {@link CymbolParser#type}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFormTypeBoolean(CymbolParser.FormTypeBooleanContext ctx);
	/**
	 * Visit a parse tree produced by the {@code FormTypeString}
	 * labeled alternative in {@link CymbolParser#type}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFormTypeString(CymbolParser.FormTypeStringContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitBoolExpr(CymbolParser.BoolExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitStringExpr(CymbolParser.StringExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitFloatExpr(CymbolParser.FloatExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitLogicExpr(CymbolParser.LogicExprContext ctx);
	/**
