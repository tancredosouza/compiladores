...
public class CymbolCheckerVisitor extends CymbolBaseVisitor<Type> {
        ...
        public Type visitFuncDecl(FuncDeclContext ctx) {
                ...
                if (funcTypeTable.containsKey(name)) {
                        ...
                        System.err.format("erro: funcao %s sendo declarada pela segunda vez na linha %d, coluna %d",
                                                                name,
                                                                line,
                                                                column);
                        System.exit(1);
        ...
        public Type visitIfStat(IfStatContext ctx) {
                ...
                if (result != Type.BOOLEAN) {
                        ...
                        System.err.format("erro: if apresenta argumentos do tipo %s quando era esperado o tipo %s na linha %d, coluna %d",
                                                                result.name(),
                                                                Type.BOOLEAN.name(),
                                                                line,
                                                                column);
        ...
        public Type visitVarDecl(CymbolParser.VarDeclContext ctx) {
                ...
                if (ctx.expr() != null) {
                        ...
                        if (!isAssignCompatible(type, exprType)) {
                                System.err.format("erro: tentativa de atribuir um %s a um %s na linha %d, coluna %d",
                                                                        exprType.name(),
                                                                        type.name(),
                                                                        line,
                                                                        column);
        ...
        public Type visitFunctionCallExpr(FunctionCallExprContext ctx) {
                ...
                if (!funcTypeTable.containsKey(funcName)) {
                        ...
                        System.err.format("error: chamada de função não declarada na linha %d, coluna %d",
                                                                 line,
                                                                 column);
                        System.exit(1);
                }
                ...
                if (ctx.exprList() != null) {
                        ...
                        for(int i = 0; i < current.size(); i++){
                                if (i >= params.size()) {
                                        ...
                                        int line = token.getLine();
                                        int column = token.getCharPositionInLine();
                                        System.err.format("erro: Chamada de função invalida na linha %d, coluna %d",
                                                                                 line,
                                                                                 column);
                                        System.exit(1);
                                }
        ...
        public Type visitAddSubExpr(CymbolParser.AddSubExprContext ctx) {
                ...
                if (((right == Type.BOOLEAN
                                        && (left != Type.STRING || operation.contains("-"))
                                || (left == Type.BOOLEAN
                                        && (right != Type.STRING || operation.contains("-")))))
                        || (operation.contains("-") && (right == Type.STRING || left == Type.STRING))
                        || right == Type.VOID || left == Type.VOID) {
                                int line = ctx.op.getLine();
                                int column = ctx.op.getCharPositionInLine();
                                System.err.format("erro: operador %s não definido entre %s e %s na linha %d, coluna %d",
                                                                  ctx.op.getText(),
                                                                  right.name(),
                                                                  left.name(),
                                                                  line,
        ...
        public Type visitMulDivExpr(MulDivExprContext ctx) {
                ...
                if (left == Type.FLOAT || right == Type.FLOAT) result = Type.FLOAT;
        ...
        public Type visitNotExpr(NotExprContext ctx) {
                ...
                if (result != Type.BOOLEAN) {
                        ...
                        System.err.format("erro: operacao ! indefinida para o tipo %s na linha %d, coluna %d",
                                                                result.name(),
                                                                line,
                                                                column);
                        System.exit(1);
        ...
        public Type visitSignedExpr(SignedExprContext ctx) {
                ...
                if (result != Type.INT && result != Type.FLOAT) {
                        ...
                        System.err.format("erro: uso de '%s' em com tipo incompatível %s na linha %d, coluna %d",
                                                                ctx.op.getText(),
                                                                result.name(),
                                                                line,
                                                                column);
