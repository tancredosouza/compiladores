...
public interface CymbolVisitor<T> extends ParseTreeVisitor<T> {
	...
	/*
	 * Função para visitar o tipo 
	 * */
	T visitFormTypeFloatExpr(CymbolParser.FormTypeFloatExpr ctx);
	/*
	 * Função para visitar o tipo 
	 * */
	T visitFormTypeBoolExpr(CymbolParser.FormTypeBoolExpr ctx);
	/*
	 * Função para visitar o tipo 
	 * */
	T visitFormTypeStringExpr(CymbolParser.FormTypeStringExpr ctx);
	/*
	 * Função para visitar o tipo 
	 * */
	T visitFormTypeLogicExpr(CymbolParser.FormTypeLogicExpr ctx);
	/*
	 * Função para visitar o tipo 
	 * */
	T visitFormTypeFloatExpr(CymbolParser.FormTypeFloatExpr ctx);
